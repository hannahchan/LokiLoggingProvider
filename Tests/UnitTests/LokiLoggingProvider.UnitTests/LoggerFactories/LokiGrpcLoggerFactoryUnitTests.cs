namespace LokiLoggingProvider.UnitTests.LoggerFactories
{
    ...
    public class LokiGrpcLoggerFactoryUnitTests
    {
        public class CreateLogger
        {
            ...
            public void When_CreatingLogger_Expect_LoggerCreated()
            {
                ...
                ILokiLoggerFactory loggerFactory = new LokiGrpcLoggerFactory(
                    options.GrpcOptions,
            ...
            public void When_CreatingLoggerWithDisposedLoggerFactory_Expect_ObjectDisposedException()
            {
                ...
                Assert.Equal(nameof(LokiGrpcLoggerFactory), objectDisposedException.ObjectName);
            }
        }
